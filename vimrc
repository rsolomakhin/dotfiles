...
au BufRead,BufNewFile /tmp/cl_description* set filetype=gitcommit
au BufRead,BufNewFile *.gyp                set filetype=python
au BufRead,BufNewFile *.gypi               set filetype=python
au BufRead,BufNewFile DEPS                 set filetype=python

au BufRead,BufNewFile * if &ft == 'cpp' |
      \ setlocal cinoptions=N-s,g.5s,h.5s

au BufRead,BufNewFile * if &ft == 'java' |
      \ setlocal tabstop=4 shiftwidth=4 softtabstop=4 textwidth=100

au BufRead,BufNewFile * if &ft == 'gitcommit' |
